...
- Name: offline.spec.ts >> Offline Support & Service Worker Caching >> [US-014#1] Service Worker registers and caches assets on first load
- Location: tests/e2e/offline.spec.ts:10:3
